...
contract stakeSOAP is Ownable {
    using SafeMath for uint256;

    address public soapAddress = 0x92077D8Ab2A229EcfDEF68F0Ad3E1A36fb841752;
    ...
    function stakeTokens(uint256 amount) public{
        ...
        //I chose _basicTransfer to try to avoid the 14% fee, but even transferFrom doesn't work.
        soapContr.transferFrom(msg.sender, address(this), amount); 

        // Tax is applied.
        uint256 stakeTax = amount.div(transferFee);
        soapContr.transfer(feeReceiver, stakeTax);
    ...
    function unstakeTokens(uint256 amount) public {
        ...
        if(isLocked == false || timeLockActivated == false){
            ...
            soapContr.transfer(msg.sender, amount);
        }
    }
